...
```python
class ArpitPrajapati:
    def __init__(self):
        self.name       = "Arpit Prajapati"
        self.alias      = "arpitcodelab"
...
| 🔭 Currently Exploring | 🌱 Actively Learning |
|:---|:---|
| 🤖 AI Agents & Agentic Workflows | 📚 LLMs & Prompt Engineering |
| 🔗 RAG Pipelines | 🧩 Agentic AI Architectures |
| ⚙️ n8n AI Workflow Automation | 🤗 Hugging Face Ecosystem |
| 🌐 Full Stack Web Apps | 🛠️ Building & Shipping Products |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/arpit-prajapati-open-to-work)
[![Kaggle](https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)](https://www.kaggle.com/arpitlab90)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/arpitcodelab)
...
*Thanks for visiting! Drop a ⭐ on something if you found it useful!*
